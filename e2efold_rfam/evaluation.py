...
def all_test_only_e2e(test_generator, rna_ss_e2e, device, test_data, conserved):
    #contact_net.eval()
    #lag_pp_net.eval()
    rna_ss_e2e.eval()
    result_no_train = list()
    ...
    batch_n = 0
    for contacts, seq_embeddings, matrix_reps, seq_lens, conservations in test_generator:
        #if batch_n %10==0:
            #print('Batch number: ', batch_n)
        batch_n += 1
